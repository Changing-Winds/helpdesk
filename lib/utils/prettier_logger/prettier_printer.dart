...
class PrettierPrinter extends LogPrinter {
  PrettierPrinter(
  ...
  List<String> _formatAndPrint(
    ...
    for (final line in message.split('\n')) {
      ...
      developer.log(
          '${levelLogColors[level]!}$verticalLine $emoji$line\u001b[1;0m',
          name: className);
    }
